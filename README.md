...
This project is based on Dataquest’s guided project, ["Credit Card Customer Segmentation,"](https://www.dataquest.io/projects/guided-project-a-credit-card-customer-segmentation/) which provided an initial framework and dataset. I completed this project as part of my own learning experience. This project is shared for educational and portfolio purposes only.
